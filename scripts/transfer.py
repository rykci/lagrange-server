...
# import not found (maybe outdated)
...
ERC_20_TOKEN_ADDRESS = "0x31174CE312C34b64eaf75d97bA0cfbEb28E4B45D"
...
print(f"Your have {eth_balance/(10**18)} MATIC for gas fees")
...
print(f"Broadcasted transaction {tx_hash.hex()}, now waiting for receipt")
